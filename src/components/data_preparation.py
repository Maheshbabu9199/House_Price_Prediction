...
class DataPreparation:
    ...
    def create_pipeline(self):
        try:
            ...
            # 'living_measure',
            # self.required_columns = ['long','total_area', 'room_bed', 'sight', 'quality', 'ceil_measure', 'zipcode', 'lat', 'price'] #             'total_area',  'sight', 'price']

            # final columns: {'long': 0, 'total_area': 0, 'room_bed': 0, 'sight': 0, 'quality': 0, 'ceil_measure': 0, 'zipcode': 0, 'lat': 0}
            
            # ['lot_measure','room_bed', 'sight','ceil_measure', 'quality', 'zipcode', 'lat', 'long', 'furnished', 'total_area','living_measure15', 'price']
...
"""
    ...
    def run_pipeline(self):
        try:
            ...
            logging.warning(f'new order of columns for training: {new_columns}')
